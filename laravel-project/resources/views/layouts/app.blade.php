    ...
    <header class="header">
        ...
        <div class="search-bar">
            <form action="{{ route('items.index') }}" method="get">
                ...
                @endif
                <input type="text" value="{{ session('keyword') }}" name="keyword" class="search-input" placeholder="なにをお探しですか？">
        ...
        <nav class="nav-links">
            ...
            @endguest
            <a href="{{ route('mypage.index', ['page' => 'buy']) }}" class="nav-link">マイページ</a>
            <a href="/items/create" class="nav-link">出品</a>
        </nav>
    </header>
